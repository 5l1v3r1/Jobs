...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td>
          <p><br /><img src="images/mem_info.png" width="227" height="57" /><br /></p>
          <p>會員編號 : <?php echo "$run[userid]" ?></p>
          <p>公司名稱 : <?php echo "$run[company_name]" ?></p>
          <p>電郵地址 : <?php echo "$run[email]" ?></p>
          <p>電話號碼 : <?php echo "$run[tel]" ?></p>
          <p>傳真號碼 : <?php echo "$run[fax]" ?></p>
          <p>公司地址 : <?php echo "$run[address]" ?></p>
          <p>最後登入 : <?php echo "$run[last_login]" ?></p>
		</td>
      </tr>
    </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
